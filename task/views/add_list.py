...
from task.forms import AddTaskListForm
...
def add_list(request) -> HttpResponse:
    """Allow users to add a new task list to the group they're in.
    """

    # Only staffers can add lists, regardless of task_STAFF_USER setting.
    ...
    return render(request, "task/add_list.html", context)
