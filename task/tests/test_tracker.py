...
from task.mail.consumers import tracker_consumer
...
def test_tracker_task_creation(task_setup, django_user_model):
    ...
    msg["References"] = "<thread-{}@django-task> <unknown@example.com>".format(task.pk)
