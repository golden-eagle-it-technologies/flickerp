...
urlpatterns = [
    ...
    path('employees/', views.EmployeeListView.as_view(), name="employees_page"),
    path('employee/<pk>/', views.EmployeeDetailView.as_view(), name="employee_page"),
    path('edit_employee_page/<pk>/', views.EmployeeUpdateView.as_view(), name="edit_employee_page"),
    ...
    path('add_new_employee/', views.EmployeeCreateView.as_view(), name="add_new_employee"),
