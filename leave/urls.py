...
urlpatterns = [
    # Pages 
    path('', views.LeaveDashboard.as_view(), name="leave_dashboard_page"),
    ...
    path('types/', views.LeaveTypeListView.as_view(), name="leave_types_page"),
    path('apply/', views.LeavePage.as_view(), name="apply_leave_page"),
    ...
    path('edit_type/<pk>/', views.LeaveTypeEditView.as_view(), name="edit_leave_type_page"),
    path('edit_leave_type/<pk>/', views.LeaveTypeEditView.as_view(), name="edit_leave_type"),
    path('delete_type/<int:id>/', views.delete_leave_type, name="delete_leave_type"),
    path('apply_leave/', views.ApplyLeave.as_view(), name="apply_leave"),
